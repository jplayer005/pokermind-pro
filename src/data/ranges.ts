...
export const DRILL_QUESTIONS: PreflopDrillQuestion[] = [
  ...
  // --- Mais Push/Fold ---
  {
    ...
    correctAction: 'shove',
    correctFrequency: 1.0,
    explanation: 'A9o com 12 BBs no SB é um shove claro. Com stack curto, A9o tem equity suficiente contra o range de call do BB e fold equity para lucrar. Abrir/fold desperdiça chips; shove é a jogada correta.',
  ...
  },
  {
    ...
    correctAction: 'shove',
    correctFrequency: 1.0,
    explanation: 'Com 8 BBs no BTN, 55 é um shove muito lucrativo. Pares médios/pequenos shoveiam de forma muito ampla com stack curto pois têm ~50% vs overcards quando chamados e excelente fold equity contra os blinds.',
    evComparison: { fold: 0, call: 0, raise: 2.1 }
  },
  // --- BB Defense ---
  {
  ...
  },
  {
    ...
    correctAction: '4bet',
    correctFrequency: 0.75,
    explanation: 'A5s é o 4-bet bluff padrão. Motivos: (1) Bloqueia combos de AA — reduzo de 6 para 3 os combos que me batem; (2) Bloqueia AK, AQ — mãos que o villain chamaria; (3) Quando chamado, tenho nut flush draw + overcard. Estratégia: 4-bet/fold vs shove do villain.',
  ...
  },
  {
    ...
    correctAction: '4bet',
    correctFrequency: 1.0,
    explanation: 'AKs é sempre 4bet — é a mão de valor máximo não-par. Vs BTN 3bet, você tem equity forte e quer construir pote. AKs também bloqueia combos de AA (1 Ace fora) e pode ganhar flops como A-x-x ou K-x-x. 4bet/fold vs shove (preserva equity).',
  ...
  },
  {
    ...
    correctAction: 'call',
    correctFrequency: 0.9,
    explanation: 'TT vs BTN 3bet no UTG: principalmente call. TT é uma mão de médio valor que não tem equity para 4bet frequentemente vs BTN 3bet range (QQ+/AKs+). Call e realize equity. Se 4bet, BTN pode shove com KK/AA — você está em mau spot. Call e jogue a mão OOP cuidadosamente.',
  ...
  },
  {
    ...
    correctAction: 'shove',
    correctFrequency: 1.0,
    explanation: '66 no BTN com 12bb: push. BTN push range a ~10-15bb inclui 66+ confortavelmente. Você tem fold equity considerável vs SB/BB, e quando chamado, 66 tem ~45-50% equity vs maioria dos call ranges. Shove é correto — esperar por mãos melhores com 12bb é muito passivo.',
  ...
  },
  {
    ...
    correctAction: 'shove',
    correctFrequency: 1.0,
    explanation: 'KTo no SB com 10bb: shove. SB push range a 10bb é amplo — vs apenas BB, você tem excelente fold equity e KTo está claramente no range. KTo tem ~58% equity vs BB call range. Push para ganhar os blinds ou entrar em pote com equity positiva. Fold seria muito passivo.',
  ...
  },
  {
    ...
    correctAction: 'shove',
    correctFrequency: 0.85,
    explanation: '87s no CO com 8bb: shove. Com stack curtíssimo, conectores suited perdem implied odds mas têm equity de push. A 8bb, 87s tem fold equity suficiente e ~38% equity quando chamado. O push EV é positivo por causa do fold equity vs 3 players. Push é correto.',
    evComparison: { fold: 0, call: 0, raise: 1.8 }
  },
  {
    id: 'q145',
    ...
    correctAction: 'fold',
    correctFrequency: 0.7,
    explanation: 'Q9o no BTN com 15bb: fold/shove mix, levemente fold. A 15bb, o push range do BTN está entre ~50-60% das mãos, mas Q9o é borderline. Solver mistura aqui — a 15bb tem mais opções (pode abrir para 2.5x). Shove com Q9o pode ser chamado por mãos que dominam. Fold/abertura normal são preferíveis.',
    evComparison: { fold: 0, call: 0, raise: 0.3 }
  },
  {
    id: 'q146',
    ...
    correctAction: 'shove',
    correctFrequency: 0.9,
    explanation: 'JTo no SB com 12bb: shove. SB push range a 12bb inclui JTo claramente. Vs apenas BB, você tem ~55% fold equity e JTo tem boa equity quando chamado (~45%). Push maximiza EV — muito melhor que limp/fold ou min-raise que desperdiça stack.',
  ...
  },
  {
    ...
    correctAction: 'shove',
    correctFrequency: 1.0,
    explanation: '55 no HJ com 10bb: shove. Par médio com fold equity razoável e equity de ~50% quando chamado vs overcards. HJ push range a 10bb inclui 55+. Push faz sentido — você pode ganhar cegos imediatamente ou entrar em coinflip favorável. Fold seria muito tight com 10bb.',
  ...
  },
  {
    ...
    correctAction: 'shove',
    correctFrequency: 1.0,
    explanation: 'K8s no BTN com 8bb: shove obrigatório. Com 8bb, quase toda mão razoável é push no BTN. K8s tem excelente equity quando chamado (boa equity vs A-x, domina K7s-), e fold equity considerável vs SB/BB. Push tudo que tem equity positiva a 8bb na BTN.',
  ...
  },
  {
    ...
    correctAction: 'shove',
    correctFrequency: 1.0,
    explanation: '99 no CO com 15bb: shove. Par médio-alto com equity sólida. CO push range a 15bb inclui claramente 99. Quando chamado, 99 tem ~70% vs broadways e ~55% vs Ax. Fold equity razoável vs 3 players. Push maximiza EV — não há razão para fold com 99 a 15bb.',
